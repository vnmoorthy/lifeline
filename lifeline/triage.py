...
CUES = {
    "cpr":        ["cardiac", "cardiac arrest", "chest compressions", "heart stopped", "no pulse", "no heartbeat",
                   "heartbeat", "feel a pulse", "can't feel a pulse", "cant feel a pulse", "can't find a pulse",
                   "cant find a pulse", "do cpr", "start cpr", "perform cpr", "needs cpr", "cpr"],
    "choke":      ["choking", "choke", "something stuck in", "object stuck", "stuck in his throat",
                   "stuck in her throat", "stuck in their throat", "stuck in throat", "lodged in", "can't swallow",
                   "caught in his throat", "caught in her throat", "caught in throat", "caught in my throat",
                   "down the wrong way", "went down the wrong", "wrong pipe", "gagging"],
    "bleed":      ["bleeding heavily", "bleeding", "bleeding from", "deep cut", "cut", "gash", "deep gash", "wound",
                   "gushing", "spurting", "hemorrhage", "laceration", "arterial", "stab", "puncture", "lots of blood",
                   "lot of blood", "so much blood", "losing blood", "losing a lot of blood", "covered in blood",
                   "blood everywhere", "pool of blood", "blood soaking", "blood gushing", "blood spurting",
                   "blood pouring", "blood coming", "blood running", "blood dripping"],  # NOT bare "blood" (false-matched "blood sugar")
    "od":         ["overdose", "overdosed", "overdosing", "od-ing", "blue lips", "lips are blue", "lips turning blue",
                   "pinpoint", "opioid", "opioids", "shot up"],
    "burn":       ["burn", "burned", "burnt", "scald", "scalded", "boiling water", "steam", "hot water", "caught fire",
                   "on fire", "hot stove", "touched the stove", "hot pan", "hot iron", "hot metal", "grabbed something hot"],
    "anaphylaxis": ["allergic reaction", "anaphylaxis", "anaphylactic", "epipen", "epi pen", "epinephrine",
                    ...
                    "throat swelling", "throat is swelling", "swelling shut", "swelling up", "face is swelling",
                    "lips are swelling", "tongue is swelling", "hives", "bee sting", "stung by", "peanut", "allergic and"],
    "stroke":     ["stroke", "face is drooping", "face drooping", "drooping", "slurred", "slurring", "can't speak",
                   "cant speak", "can't talk", "cant talk", "one side of", "one side", "went numb", "numb on one side",
                   "weak on one side", "lift one arm", "arm went weak", "weakness on one side", "sudden weakness",
                   "sudden confusion", "suddenly confused", "can't move one side"],
    "seizure":    ["seizure", "seizing", "convuls", "epilep", "having a fit", "jerking", "twitching",
                   "foaming at the mouth", "shaking uncontrollably", "shaking all over", "whole body is shaking",
                   "convulsing", "shaking on the floor", "violent shaking", "shaking violently", "won't stop shaking"],
    "heart_attack": ["heart attack", "chest pain", "chest pressure", "pressure in my chest", "pressure in his chest",
                     ...
                     "tight chest", "chest hurts", "chest hurt", "crushing", "clutching his chest", "clutching her chest",
                     "clutching their chest", "pain spreading to", "pain down", "left arm", "arm and jaw", "squeezing feeling in"],
    "drown":      ["drowning", "drowned", "aspirated water", "went under water", "underwater", "under water"],
    "hypoglycemia": ["diabetic", "diabetes", "blood sugar", "hypoglycemia", "hypoglycaemia", "hypoglycemic",
                     "hypoglycaemic", "low sugar", "sugar is low", "sugar crashed", "took insulin", "insulin and"],
    ...
    "hypothermia": ["hypothermia", "freezing", "frostbite", "ice cold", "shivering", "stopped shivering",
                    "cold to the touch", "out in the cold", "in the cold", "too cold for", "cold for too long",
                    "so cold", "really cold", "fell into a freezing", "fell into freezing"],
    "poison":     ["poison", "poisonous", "swallowed", "drank bleach", "drank some", "drank something", "drain cleaner",
                   "cleaning chemical", "cleaning product", "detergent", "ate detergent", "laundry pod", "dish soap",
                   "household chemical", "antifreeze", "ate pills", "swallowed pills", "bunch of pills", "ate something",
                   "ingested", "toxic", "drank chemical"],
    ...
    "fracture":   ["broken bone", "broken arm", "broken leg", "broken", "it's broken", "is broken", "might be broken",
                   "broke his", "broke her", "broke my", "fracture", "fractured", "bone is sticking out",
                   "bone sticking out", "bone is out", "out of place", "dislocated", "bent the wrong way",
                   "bent at a weird angle", "deformed", "looks crooked", "heard a snap", "snapped", "compound fracture",
                   "open fracture", "sprain", "sprained", "twisted my ankle", "twisted ankle", "rolled my ankle"],
}
...
OD_SOFT = ["overdose", "overdosed", "overdosing", "took too much", "took too many pills", "took something",
           "od'd", "od-ing", "shot up", "injected"]
DROWN_CUES = ["drowning", "drowned", "out of the pool", "pulled out of the pool", "pulled from the pool",
              "from the pool", "out of the water", "fell in the pool", "fell into the pool", "fell in the water",
              "fell into the water", "into the pool", "into the lake", "fell in the lake", "fell into the lake",
...
CHOKE_OBJECT = ["chok", "stuck", "lodged", "object", "swallowed something", "swallowed a ", "swallowed an "]
